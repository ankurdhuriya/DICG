...
from envs.ma_gym.envs.predator_prey_hex import PredatorPrey
            ...
            if self._agent_visible:
                for i_agent in range(self.n_agents):
                    ...
                    for i in range(self._agent_view_mask[1]):
                        _agent_pos.append(self.find_agent_in_direction(pos, i, self._agent_view_mask[0]))

                    obs[i_agent].extend(np.array(_agent_pos).flatten().tolist())
            return obs
